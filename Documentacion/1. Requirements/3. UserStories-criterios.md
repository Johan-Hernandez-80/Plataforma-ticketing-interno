...
- Como user de la app
  Quiero ver solo la información esencial de los tickets en la lista  
  Para poder identificar rápidamente cada uno sin necesidad de leer todos sus detalles
