...
ON CONFLICT (ticket_id, usuario_id, fecha_creacion) DO UPDATE SET
...
ON CONFLICT (ticket_id, fecha_creacion) DO UPDATE SET
...
ON CONFLICT (usuario_id, fecha_creacion) DO UPDATE SET
