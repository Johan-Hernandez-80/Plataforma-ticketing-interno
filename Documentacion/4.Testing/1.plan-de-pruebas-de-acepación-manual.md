...
```json
{
  ...
  "prioridad": "urgente",
  "estado": "pendiente",
  "fechaCreacion": "2025-09-28T10:15:00Z",
  "fechaCierre": "2025-09-29T20:00:00Z"
}
```
...
- **Prueba Exitosa si**:
  ...
  - La respuesta contiene un objeto JSON con los datos del ticket creado, incluyendo su ID,
    fechaCreacion, y un estado inicial.
...
- **Descripción**:Este caso de prueba verifica que el sistema retorne un error
  ...
  inexistentes, como un usuarioId, categoriaId o prioridad que no existen en
  la base de datos.
- **Cuerpo de la petición**:
...
```json
{
  ...
  "detalles": "El usuarioId 123 no existe en la base de datos."
}
```
...
- **Endpoint**: `localhost:8080/api/tickets?estado=enProgreso&prioridad=urgente&usuarioId=123`
- **Método HTTP**: `GET`
...
[
  {
    ...
    "estado": "enProgreso",
    "fechaCreacion": "2025-09-25T09:00:00Z",
    "fechaCierre": null,
    "agenteId": 123
  },
  {
    ...
    "prioridad": "urgente",
    "estado": "cerrado",
    "fechaCreacion": "2025-09-20T14:30:00Z",
    "fechaCierre": "2025-09-21T10:15:00Z",
    "agenteId": 123
  }
]
```
...
[
  ...
  },
  {
    ...
    "fechaCreacion": "2025-09-26T08:15:00Z"
  }
]
```
...
```json
{
  "emailPersonal": "nuevo.correo@example.com",
...
[
  ...
  },
  {
    ...
    "usuarioId": 322,
    "categoriaId": 3,
    "descripcion": "Necesito permisos especiales para acceder a la vpn",
    "prioridad": "importante",
    "fechaCreacion": "2025-09-28T10:15:00Z",
    "fechaCierre": null
  }
...
[
  ...
  },
  {
    ...
    "agenteId": 123,
    "descripcion": "Al intentar subir un documento PDF, aparece un mensaje de error y no se completa la carga.",
    "estado": "cerrado",
    "categoriaId": 3,
    "prioridad": "importante",
    "fechaCreacion": "2025-10-05T14:30:00Z",
    "fechaCierre": "2025-10-07T09:45:00Z"
  }
]
```
...
```json
{
  ...
  "usuarioId": 45,
  "comentario": "Estamos revisando el problema y pronto tendrás una solución.",
  "fechaCreacion": "2025-09-29T20:00:00Z"
}
```
...
- **Prueba Exitosa si**:
  ...
  - El usuarioId es el mismo que envió la petición.
  - El texto del comentario coincide con lo enviado en la solicitud.
  - Se incluye la fechaCreacion generada automáticamente por el sistema.
...
```json
{
  ...
  "estado": "enProgreso",
  "categoriaId": 3,
  "fechaCreacion": "2025-09-28T14:30:00Z",
  "fechaCierre": null
}
```
...
- **Endpoint**: `localhost:8080/api/tickets?estado=pendiente
...
[
  ...
  },
  {
    ...
    "estado": "enProgreso",
    "agenteId": 46,
    "fechaCreacion": "2025-09-28T15:00:00Z",
    "fechaCierre": null
  }
]
```
