...
public class NotificacionController extends BaseController<Notificacion, Long, NotificacionDTO, NotificacionDAO, NotificacionMapper, NotificacionFilter> {

    public NotificacionController(BaseService<Notificacion, Long, NotificacionDAO> service, NotificacionMapper mapper, NotificacionFilter filter) {
