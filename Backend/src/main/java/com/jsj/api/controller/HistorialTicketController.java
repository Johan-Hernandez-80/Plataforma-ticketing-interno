...
import com.jsj.api.util.mapper.HistorialTicketMapper;
...
public class HistorialTicketController extends BaseController<HistorialTicket, Long, HistorialTicketDTO, HistorialTicketDAO, HistorialTicketMapper> {

    public HistorialTicketController(BaseService<HistorialTicket, Long, HistorialTicketDAO> service, HistorialTicketMapper mapper) {
