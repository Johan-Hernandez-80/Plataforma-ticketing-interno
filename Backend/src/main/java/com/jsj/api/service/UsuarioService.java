...
public class UsuarioService extends BaseService<Usuario, Long, UsuarioDTO, UsuarioDAO> {
  ...
  public UsuarioService(PasswordEncoder passwordEncoder, NotificacionDAO notificacionDAO, RolDAO rolDAO,
      UsuarioDAO dao) {
    super(dao);
  ...
  public UsuarioDTO validateCredentials(String email, String password) {
    UsuarioDTO user = dao.findByEmailPersonal(email);
    if (user == null) {
  ...
  public UsuarioDTO updateUsuario(Long idUsuario, UsuarioDTO dto)
      throws UsuarioInexistenteException, InsufficientSavingPermissionsException, RolInexistenteException,
      IdInvalidaException, EmailInvalidoException, ImmutableFieldException {
  ...
  public UsuarioDTO save(UsuarioDTO dto) throws IdInvalidaException, EmailInvalidoException, RolInexistenteException,
      InsufficientSavingPermissionsException, ContrasenaInvalidaException {
