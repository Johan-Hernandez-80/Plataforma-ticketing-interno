...
import { UpdateAdminCardComponent } from '../../shared/molecules/update-admin-card/update-admin-card.component';

@Component({
  selector: 'app-update-admin-page',
  standalone: true,
  imports: [BackgroundComponent, UpdateAdminCardComponent, ConfirmModalComponent],
  templateUrl: './update-admin-page.component.html',
  styleUrl: './update-admin-page.component.css'
})
export class UpdateAdminPageComponent {
  showModal = false;
