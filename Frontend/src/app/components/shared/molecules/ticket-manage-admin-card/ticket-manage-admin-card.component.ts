...
@Component({
  selector: 'app-ticket-manage-admin-card',
  standalone: true,
  imports: [
    CardComponent,
    MainButtonComponent,
  ...
  templateUrl: './ticket-manage-admin-card.component.html',
  styleUrl: './ticket-manage-admin-card.component.css'
})
export class TicketManageAdminCardComponent implements OnInit {
