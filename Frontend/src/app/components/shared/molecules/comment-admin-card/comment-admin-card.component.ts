...
@Component({
  selector: 'app-comment-admin-card',
  standalone: true,
  imports: [TextBoxComponent, CardComponent, RouterModule],
  templateUrl: './comment-admin-card.component.html',
  styleUrl: './comment-admin-card.component.css'
})
export class CommentAdminCardComponent implements OnInit {
