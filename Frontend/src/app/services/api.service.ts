...
export class ApiService {
  ...
  login(
    ...
    return this.http.post<{ usuario: UsuarioDTO; token: string }>(
  ...
  // UsuarioController
  getAllAgentes(): Observable<UsuarioDTO[]> {
    return this.http.get<UsuarioDTO[]>(
      `${this.apiUrl}/usuarios/agentes`,
      this.httpOptions,
    );
  }
  ...
  getComentariosByTicketId(idTicket: number): Observable<ComentarioDTO[]> {
    return this.http.get<ComentarioDTO[]>(
      `${this.apiUrl}/tickets/${idTicket}/comentarios`,
      this.httpOptions,
    );
  }
  ...
  createComentario(
    ticketId: number,
    comentarioDTO: Omit<ComentarioDTO, "id" | "fechaCreacion">,
  ...
  updatePrioridad(
    ...
    return this.http.patch<TicketDTO>(
      `${this.apiUrl}/tickets/${idTicket}/prioridad`,
      prioridad,
      this.httpOptions,
    );
  }
  ...
  cerrarTicket(idTicket: number): Observable<TicketDTO> {
    return this.http.patch<TicketDTO>(
      `${this.apiUrl}/tickets/${idTicket}/cerrar`,
      {},
      this.httpOptions,
    );
  }
  ...
  getTicketsFiltrados(
    ...
    return this.http.get<TicketDTO[]>(`${this.apiUrl}/tickets/filtered`, {
      ...this.httpOptions,
      params,
    });
  }
  ...
  getTicketsFiltradosAgente(
    ...
    if (fecha) params = params.set("fecha", fecha);
    return this.http.get<TicketDTO[]>(
      `${this.apiUrl}/agentes/${agenteId}/tickets`,
  ...
  exportarInformePDF(): Observable<Blob> {
    return this.http.get(`${this.apiUrl}/admin/estadisticas/exportar/pdf`, {
      responseType: "blob",
    });
  }
}
